...
parser.add_argument(
    ...
    type=str, 
    required=False, 
    default='/home/ubuntu/uzair/fine_tuning_stt/output_model_dir', 
...
parser.add_argument(
    ...
    nargs='+', 
    required=False, 
    default= ['/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00006-of-00011.arrow','/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00010-of-00011.arrow', '/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00005-of-00011.arrow', '/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00009-of-00011.arrow', '/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00008-of-00011.arrow', '/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00004-of-00011.arrow', '/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00007-of-00011.arrow', '/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00000-of-00011.arrow', '/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00003-of-00011.arrow', '/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00002-of-00011.arrow', '/home/ubuntu/uzair/fine_tuning_stt/train_data_dir/data-00001-of-00011.arrow'],
...
parser.add_argument(
    ...
    nargs='+', 
    required=False, 
    default=['/home/ubuntu/uzair/fine_tuning_stt/test_data_dir/data-00001-of-00002.arrow', '/home/ubuntu/uzair/fine_tuning_stt/test_data_dir/data-00000-of-00002.arrow'],
...
def is_in_length_range(length, labels):
    result = min_input_length < length < max_input_length and 0 < len(labels) < max_label_length
    return result
...
class DataCollatorSpeechSeq2SeqWithPadding:
    ...
    def __call__(self, features: List[Dict[str, Union[List[int], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
        ...
        if (labels[:, 0] == self.processor.tokenizer.bos_token_id).all().cuda().item():
            labels = labels[:, 1:]
